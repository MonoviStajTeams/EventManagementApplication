    ...
    public partial class createModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInvitationMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserInvitationMappings_Invitations_InvitationId",
                        column: x => x.InvitationId,
                        principalTable: "Invitations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInvitationMappings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInvitationMappings_InvitationId",
                table: "UserInvitationMappings",
                column: "InvitationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInvitationMappings_UserId",
                table: "UserInvitationMappings",
                column: "UserId");
